  ...
  return (
    <div className="flex flex-row items-center justify-between">
      ...
      <div className="flex flex-row gap-2">
        <button className="bg-bg-secondary border border-line hover:bg-bg-secondary-hover p-3 rounded-lg text-purple-primary transition-all cursor-pointer font-medium">
          New Group
        </button>
        <button className="bg-bg-secondary border border-line hover:bg-bg-secondary-hover p-3 rounded-lg text-purple-primary transition-all cursor-pointer font-medium">
          New Secret
